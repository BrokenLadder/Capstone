...
short_pos = open("C:/Users/Gabe B/Desktop/NeumontWork/Q42018/Capstone/DataSets/SmallTextDataSet/positive.txt", "r").read()
short_neg = open("C:/Users/Gabe B/Desktop/NeumontWork/Q42018/Capstone/DataSets/SmallTextDataSet/negative.txt", "r").read()
documents = []
all_words = []
...
# This makes the all_words only add Adjectives
...
saved_features = open("featuresets.pickle", "rb")
featuresets = pickle.load(saved_features)
...
save_classifier = open("Bernoulli_classifier5k.pickle", "wb")
...
print(sentiment("I loved this movie, one of the best things I have ever seen, super fun and exciting"))
print(sentiment("I absolutely hate spiders, they are the worst, they are creepy and crawly, and are super annoying to deal with"))
